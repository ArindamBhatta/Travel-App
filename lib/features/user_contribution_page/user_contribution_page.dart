...
class _UserContributionPageState extends State<UserContributionPage> {
  ...
  String? description;
  String? userUid;
  DocumentReference? referenceOfAllContributedData;
  DocumentReference? dynamicallyStoreAppUserRef;
  ...
  void submitFormAndUploadDataInFireStore() async {
    if (formKey.currentState!.validate()) {
      ...
      try {
        ...
        referenceOfAllContributedData = await FirebaseFirestore.instance
            .collection('/destinations/contributor/data')
            .doc();

        await referenceOfAllContributedData?.set(
          {
            'id': referenceOfAllContributedData?.id,
            'name': location,
            'continent': state,
            'country': country,
            'imageUri': imageUrl,
        ...
        dynamicallyStoreAppUserRef = await FirebaseFirestore.instance
            .collection('users/$userUid/contributions')
            .add(
          {
            'myContribution': referenceOfAllContributedData,
          },
        );
